//ΑΥΤΟΣ Ο ΚΩΔΙΚΑΣ ΑΝΤΙΚΑΘΙΣΤΑ ΤΟΝ ΠΡΟΗΓΟΥΜΕΝΟ ΜΕ ΟΝΟΜΑ CODE ΓΙΑΤΙ ΕΙΝΑΙ ΕΜΠΛΟΥΤΙΣΜΕΝΟΣ ΜΕ ΤΙΣ ΕΞΤΡΑ ΛΕΙΤΟΥΡΓΙΕΣ ΤΟΥ ΣΥΝΑΓΕΡΜΟΥ ΚΑΙ ΤΗΣ ΑΥΤΟΜΑΤΗΣ ΕΝΕΡΓΟΠΟΙΗΣΗΣ ΤΟΥ ΚΛΙΜΑΤΙΣΜΟΥ,ΟΜΩΣ Ο ΠΡΟΗΓΟΥΜΕΝΟΣ CODE ΘΑ ΜΕΙΝΕΙ ΣΤΟ ΕΥΡΕΤΗΡΙΟ ΩΣ ΜΙΑ ΒΑΣΗ ΓΙΑ ΜΕΛΛΟΝΤΙΚΕΣ ΤΡΟΠΟΠΟΙΗΣΕΙΣ
// I2C LCD screen demo
